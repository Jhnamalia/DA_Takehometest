...
st.markdown("""
- 📄 **Project Slide Deck**: [Stop the Churn: Telco Customer Insights & Strategy](https://drive.google.com/file/d/1du9GVJRsDiR5GZ8ar45rm9Q_4EN80YAJ/view?usp=drive_link)  
...
- 📈 **Tableau Dashboard**: [Customer Insights & Business Performance Dashboard](https://public.tableau.com/shared/CKCW2SY4J?:display_count=n&:origin=viz_share_link)  
""")
